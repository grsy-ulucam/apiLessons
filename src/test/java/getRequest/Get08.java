...
*/
       ...
       // assertEquals(expectedDataMap.get("model"),actualData.get("model"));
        ...
        softAssert.assertEquals(actualData.get("name") ,expectedDataMap.get("name"));
        softAssert.assertEquals(actualData.get("max_atmosphering_speed") ,expectedDataMap.get("max_atmosphering_speed"));

      softAssert.assertEquals(actualData,expectedDataMap);
