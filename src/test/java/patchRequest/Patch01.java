...
public class Patch01 extends RestFullBookerHerOkuAppBaseURL {
    ...
    public void patch01(){
      ...
      // Map<String,Object>actualData  = response.as(Map.class);
       ...
       // HashMap<String,Object>actualData=JsonToJava.convertJsonToJavaObject(file,HashMap.class);
       ...
       // assertEquals(actualData.get("lastname"),expectedDataAndReqBody.get("lastname"));
        ...
        assertEquals(expectedDataAndReqBody.get("firstname"),jsonPath.get("firstname"));
