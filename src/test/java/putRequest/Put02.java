...
public class Put02 extends RestFullBookerHerOkuAppBaseURL {
     ...
     "additionalneeds" : "API and Appium"
         ...
         3) Kullanıcı Auth. olarak ilk olarak  Header a Cookie ile daha sonra ise Basic Autoh ile  req bulunmalı.
             ...
             Cookie =>>> token=001832eb39ba0ca  //yeni Cookie =token= "token": " "token": "4bf5d9dc6665b51""
    ...
    "additionalneeds" : "API and Appium"
        ...
        System.out.println("restFulBookingPojo = " + restFulBookingPojo);
        ...
        Response response = given().
                ...
                header("Cookie", "token=" + "9c6553f092be50d").
       ...
       // assertEquals(jsonPath.getString("firstname"), restFulBookingPojo.getFirstname());
        ...
        //assertEquals(jsonPath.getString("lastname"),restFulBookingPojo.getFirstname());

       assertEquals(restFulBookingPojo.getFirstname(),jsonPath.getString("firstname"));
    }
}