...
public class test08 extends SwapiApiBaseURL {
...
//Step 2: Set Expected Data
  ...
  List<String>filmsList=new ArrayList<>(List.of("https://swapi.dev/api/films/1/","https://swapi.dev/api/films/5/"));
...
/*
 response.then().assertThat().statusCode(200).
         body("name",equalTo(expectedDataMap.get("name")),
                 "model", Matchers.equalTo(expectedDataMap.get("model")),

                 "manufacturer", Matchers.equalTo(expectedDataMap.get("manufacturer")),

                 "length", Matchers.equalTo(expectedDataMap.get("length")),

                 "max_atmosphering_speed", Matchers.equalTo(expectedDataMap.get("max_atmosphering_speed")),

                 "crew", Matchers.equalTo(expectedDataMap.get("crew")),

                 "cost_in_credits", Matchers.equalTo(expectedDataMap.get("cost_in_credits")),

                 "passengers", Matchers.equalTo(expectedDataMap.get("passengers")),

                 "cargo_capacity", Matchers.equalTo(expectedDataMap.get("cargo_capacity")),

                 "films", Matchers.equalTo(expectedDataMap.get("films")),

                 "pilots", Matchers.equalTo(expectedDataMap.get("pilots")));
*/
   //2.way
 ...
 softAssert.assertEquals(actualData.get("name") , expectedData.get("name"));
